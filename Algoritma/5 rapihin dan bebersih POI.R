...
data_final %>% 
  mutate(poi = case_when(
    ...
    grepl("Silverstone|Tridatu bali|bioskop|cinema|Nusantara Sejahtera Raya|cinep|xxi|cgv|teater|movie|theater|21",nama_tempat,ignore.case = T) ~ "bioskop",
    ...
    grepl("ong palace|Warong Wenang|citra palace|pondok|roll|hokben|soup|kuliner|cobek|sambal|sambel|kue|dapoer|gurih|pawon|rawon|baso|sego|raja kuring|ampera|uduk|eat|masakan|geprek|steak|takoyak|chicken|mcdona|pindang|laut|kitchen|santap|belut|food|gado|minang|kedai|waroenk|teler|richeese|bebek|warkop|sate|satay|pecel|sari laut|waroeng|fat |deli|hotplate|konro|ndut|pentol|dapur|rawon|cendol|lesehan|soto|coto|padang|burger|grill|nasi|kfc|ikan|nasgor|restau|depot|mie|crab|ayam|bfc|suki|resto|seafood|solaria|batagor|sushi|pempek|warung|makan|pizza|bakso|r.m|rm",nama_tempat,ignore.case = T) ~ "rumah makan",
